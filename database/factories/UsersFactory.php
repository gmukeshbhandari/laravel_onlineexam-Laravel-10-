...
class UsersFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $random_username_from_admins_table = Admin::inRandomOrder()->value('institute_username');
        $gender = $this->faker->randomElement(['Male', 'Female', 'Non-Binary' ,'Prefer not to say']);

        if ($gender === "Male") {
            $middlename = $this->faker->randomElement(['Bahadur', 'Prasad', 'Bhopal', 'Jung', 'Pratap', 'Ratna', 'Kumar']);
        } elseif ($gender === "Female") {
            $middlename = $this->faker->randomElement(['Devi', 'Kumari', 'Lhamu']);
        } else {
        $middlename = null; // No middle name for Non-Binary and Prefer not to say
        }
        ...
        if ($country === 'Nepal')
        {
            ...
            return [
                ...
                'institute_username' =>  $random_username_from_admins_table,
                'Gender' => $gender,
                'Country' => $country,
                ...
                'Last_Middle_Name_Update' => date('Y-m-d H:i:s'),
